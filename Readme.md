...
> NOTE : remove dependency "collections" and replace by simple javascript object {}.

> This will fix all issues with opening and recover status on new Microsoft Excel (macos, windows).
